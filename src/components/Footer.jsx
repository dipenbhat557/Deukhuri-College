  ...
  return (
    ...
    >
      <div className="flex w-full h-[40%] items-center justify-between">
        ...
        />
        <p
          className={`md:text-[35px] sm:text-[30px]  xs:text-[25px] text-[22px] text-center w-[70%] tracking-widest text-white `}
        >
          "Home of Students"
        </p>
      </div>
      <div className="w-full h-[45%] text-white flex justify-between items-center mb-8">
        <div className="h-full w-[35%] flex flex-col items-start justify-around">
          <p className="text-[18px] font-semibold tracking-wider">
            Deukhuri Multiple Campus
          </p>
          <p className="text-[16px] text-slate-500">Lamahi-6, Dang, Nepal</p>
          <p className="text-[16px] text-slate-500">
            +977 98765789, 098769 , 098790
          </p>
          <p className="text-[16px] text-slate-500">deukhuricampus@gmail.com</p>
        </div>
        <div className="h-full w-[20%] flex flex-col items-start justify-around">
          <p className="text-[18px] font-semibold tracking-wider">
            Other Links
          </p>
          <a
            href="/admission"
            className="text-[16px] text-slate-500 cursor-pointer"
          >
            Admission
          </a>
          <a
      ...
      <div className=" w-full  flex items-center justify-center text-center">
        <p className=" text-[14px] md:text-[17px] text-white leading-loose p-2 rounded-t-md ">
