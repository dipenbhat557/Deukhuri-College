  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_APP_API_ROOT}/auth/signin`,
        formData,
        {
          headers: {
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center ">
              <Link className="mb-0 inline-block" to="/">
                <img className="hidden dark:block w-[10%] h-[10%] object-contain mx-auto" src={logo}  alt="Logo" />
                <img className="dark:hidden w-[10%] h-[10%] object-contain mx-auto" src={logo} alt="Logo" />
              </Link>

              <p className="2xl:px-20 font-bold text-red-900 text-[25px]">Deukhuri Multiple Campus</p>
              ...
              <form className="flex gap-2 flex-col" onSubmit={handleSubmit}>
                ...
                <div className="flex justify-center w-full">
                  <input
                    value="Sign In"
                    type="submit"
                    className="w-[80%] cursor-pointer rounded-lg border text-center  bg-red-900 p-4 text-white  hover:bg-opacity-90"
                  />
                </div>
              </form>
            </div>
