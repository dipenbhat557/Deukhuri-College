...
public class PublicationController {
    ...
    @GetMapping("/{publicationId}/file")
    public ResponseEntity<byte[]> getFileById(@PathVariable int publicationId) {
        return new ResponseEntity<>(this.publicationService.getFileById(publicationId), HttpStatus.OK);
    }
